...
<body>
    ...
    <footer id="contact" class="bg-dark text-white text-center py-4">
        <div class="container">
            <p class="mb-0">&copy; 2025 Designed and developed by JEYAPRIYA.J(212224100027). All rights reserved.</p>
        </div>
    </footer>
...
![Screenshot (8)](https://github.com/user-attachments/assets/37964808-2889-48b7-b37c-c632d0d87229)
